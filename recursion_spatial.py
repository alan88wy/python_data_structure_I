...
def drawSpiral(t, length, color, colorBase): 
    ...
    # add 2ˆ10 to the old color modulo 2ˆ24 # the modulo 2ˆ24 prevents the color from # getting too big.
    ...
    # # add the base modulo 2ˆ24. if newcolor < base:
...
def main(): 
    ...
    drawSpiral(t, 250, "#000000", "#ff00ff") 
